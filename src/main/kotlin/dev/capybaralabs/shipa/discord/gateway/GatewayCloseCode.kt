...
// Our Client side close codes. Range should be 1000 <= x < 5000
enum class OutboundGatewayCloseCode(
	override val value: Int,
	override val reconnect: Boolean,
) : GatewayCloseCode {

	ZombieConnection(CloseStatus.SESSION_NOT_RELIABLE.code, true),
	ResumeOrReconnect(4201, true),
	ReconnectNoResume(4202, true),
