...
/**
 * [Discord Permissions](https://discord.com/developers/docs/topics/permissions#permissions-bitwise-permission-flags)
 */
enum class Permission(override val value: Long) : StringBitflag {
	...
	// careful when going over 1L << 63, will need a different number representation than Long
}
